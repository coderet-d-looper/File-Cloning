...
def m1(ids,names,passlist):
        global loop,oks,cps
        bi = random.choice([A,B,C,D,E,F,G,H])
        sys.stdout.write(f'\r \033[1;31m[%sDARK•M1\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,ids,len(oks))),
        sys.stdout.flush()
